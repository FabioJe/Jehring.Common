...
namespace Jehring.Common
{
    ...
    {
        private static readonly Lazy<IDictionary<string, string>> _mappings = new Lazy<IDictionary<string, string>>(new Func<IDictionary<string, string>>(BuildMappings));
            ...
            Dictionary<string, string> source = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
      {
        ...
        },
        {
          ...
          ".xof"
            ...
            foreach (KeyValuePair<string, string> keyValuePair in source.ToList())
            {
        ...
        public static string GetMimeType(string extension)
        {
            ...
            if (!extension.StartsWith("."))
                extension = "." + extension;
            return !_mappings.Value.TryGetValue(extension, out string str) ? "application/octet-stream" : str;
        }
        ...
        public static string GetExtension(string mimeType, bool throwErrorIfNotFound)
        {
            ...
            if (_mappings.Value.TryGetValue(mimeType, out string str))
                return str;
